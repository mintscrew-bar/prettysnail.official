...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: '제품 수령 후 7일 이내에 고객센터로 연락주시면 교환 또는 환불 처리해드립니다. 단, 제품 개봉 후에는 교환 및 환불이 어려울 수 있습니다.',
  },
  {
    id: 'faq-006',
    category: '반품/교환',
    question: '불량 제품을 받았어요. 어떻게 해야 하나요?',
    answer: '제품 불량 시 즉시 고객센터(010-0000-0000)로 연락주시면 새 제품으로 교환해드립니다. 불량 제품은 반송비 없이 교환 가능합니다.',
  },
];
