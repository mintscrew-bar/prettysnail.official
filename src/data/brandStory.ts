...
export const brandStory: BrandStory = {
  ...
  farm: {
    heading: '신선함의 시작',
    description: '깨끗한 수질 관리와 정성스러운 양식 기술로 건강하고 품질 좋은 우렁이를 키웁니다. 우리의 양식장은 최고의 환경에서 최고의 제품을 만들기 위한 약속입니다.',
  ...
  cta: {
    ...
    description: '건강하고 맛있는 우렁이 제품을 합리적인 가격으로 경험해보세요. 신선함과 신뢰, 두 가지 모두를 담았습니다.',
    buttonText: '제품 둘러보기',
    buttonLink: '/products',
  },
};
